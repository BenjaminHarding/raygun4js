...
interface TraceKit {
    ...
    extendToAsynchronousCallbacks: () => void;
    remoteFetching: boolean;
    collectWindowErrors: boolean;
    linesOfContext: number;
};

// Cast placeholders as they will be reset below 
const TraceKit: TraceKit = {
    wrap: () => null,
    report: null as any,
    computeStackTrace: null as any,
    extendToAsynchronousCallbacks: () => null,
...
TraceKit.computeStackTrace = (function computeStackTraceWrapper() {
     ...
     */
    const computeStackTrace = function(ex, depth) {
        var stack = null;
